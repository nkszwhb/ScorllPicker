package com.scrollpicker.android.scrollpickerlibrary.view;
...
import com.scrollpicker.android.scrollpickerlibrary.IPickerViewOperation;
import com.scrollpicker.android.scrollpickerlibrary.util.ScreenUtil;
...
public class ScrollPickerView extends RecyclerView {
    ...
    private void processItemOffset() {
        ...
        itemOffset = getScrollYDistance() / mItemHeight;
    }
...
//                        return;
                    ...
                    if (offset >= mItemHeight / 2) {//滚动区域超过了item高度的1/2，调整position的值
                        itemOffset = (getScrollYDistance() - offset)/mItemHeight;
