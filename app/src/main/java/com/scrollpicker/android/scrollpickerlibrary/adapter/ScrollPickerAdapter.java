package com.scrollpicker.android.scrollpickerlibrary.adapter;
...
import com.scrollpicker.android.scrollpickerlibrary.provider.DefaultItemViewProvider;
...
public class ScrollPickerAdapter<T> extends RecyclerView.Adapter<ScrollPickerAdapter.ScrollPickerAdapterHolder> implements IPickerViewOperation {
    ...
    private View positionItemView;

    public View getPositionItemView() {
